...
public class AskUserInput {
    ...
    public void createCourse() {
        ...
        Course2 c = new Course2(title, stream, type, enarksi, enarksi);
    ...
    public void createStudent() {
        ...
        Student2 s = new Student2(firstName, lastName, gennisi, fees);
    ...
    public void createTrainer() {
        ...
        Trainer2 t = new Trainer2(firstName, lastName, subject);
    ...
    public void createAssignment() {
        ...
        Assignment2 a = new Assignment2(title, description, deadline);
...
////////////// set methods
    ...
    public void setStudentToCourse() {
        ...
        Main2.setStudentToCourse(PrivateSchool.courseList.get(courseChoice - 1),
    ...
    public void setTrainerToCourse() {
        ...
        printCourseList();
        int courseChoice = sc.nextInt();
        Main2.setTrainerToCourse(PrivateSchool.courseList.get(courseChoice - 1),
    ...
    public void setAssignmentToCourse() {
        ...
        Main2.setAssignmentToCourse(PrivateSchool.courseList.get(courseChoice - 1),
    ...
    public void printCoursesPerStudent() {
        printStudentList();
        int studentChoice = sc.nextInt();
        Main2.printCoursesPerStudent(PrivateSchool.studentList.get(studentChoice - 1));
    }

    public void printAssignmentsPerStudent() {
        printStudentList();
        int studentChoice = sc.nextInt();
        Main2.printAssignmentsPerStudent(PrivateSchool.studentList.get(studentChoice - 1));
    }
